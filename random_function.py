    ...
    try:
        ...
        for route_pair, id_list in route_groups.items():
            ...
            for arbitrationID_raw in id_list:
                ...
                # --- NEW: Generate a unique 8-byte signature for this specific ID ---

                dummy_data = [hex(random.randint(0, 255)) for _ in range(8)]
                ...
                for attempt in range(MAX_RETRIES):
                    ...
                    # --- NEW: Flush the receiver's stale buffer to prevent "Ghosts" ---
                    ...
                    while time.time() < timeout_end:
                        ...
                        if receivedMessage:
                            ...
                            # If it has our dummy data, we know it's our routed frame!
